...
<body>
		...
		<section class="col col-md-9 container mb-3 p-4 pt-3 border-start">
			...
			<div class="col-6">
				...
				<div class="col-6">
					...
					<input type="text" class="form-control" readonly v-model="paquete.destino.destino">
				</div>
				<div class="col-6">
				...
				<div class="col-6 d-flex align-items-center">
					<button class="btn btn-success"><i class="bi bi-floppy"></i> Editar paquete</button>
				</div>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr v-for="(participante, index) in paquete.participantes">
										...
										<td><a :href="'participante-perfil.php?id='+participante.id" class="text-decoration-none">{{participante.apellidos}} {{participante.nombres}}</a></td>
	...
	createApp({
		setup() {
			const paquete = ref({cliente:[], destino:[], cuotas:[], viajes:[], participantes:[], proveedores:[]})
			const servidor = '<?= $api ?>'
			const busqueda = ref('')
			...
			return {
				paquete,fechaLatam, registroCuota, guardarCuota, eliminarCuota, registroViaje, guardarViaje, busqueda, participantes, buscarParticipante, busqueda, agregarParticipante, buscarProveedor, agregarProveedor, proveedores, eliminarProveedor, eliminarViajes, eliminarParticipantes
			}
		}
	}).mount('#app')
</script>
